            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/profil" onclick="window.location.href='/profil'">Profil
                                Pengabdi</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/questioner" onclick="window.location.href='/questioner'">Cek
                                Kesehatan Mental</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-8 col-lg-8" id="content-3">
                    <div class="containers position-relative">
                        <div class="card-carousel d-flex overflow-hidden">
